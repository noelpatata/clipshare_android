package com.clipshare.app.certs
 ...
 *
 * Its password is [P12_PASSWORD] (constant, matches the desktop export).
 */
object CertStore {
    const val P12_PASSWORD = "clipshare"
    ...
    fun clientTls(context: Context): ClientTls? {
        ...
        return try {
            ...
            ).apply { init(ks, P12_PASSWORD.toCharArray()) }.keyManagers
    ...
    private fun loadKeyStore(file: File): KeyStore {
        ...
        file.inputStream().use {
            ks.load(it, P12_PASSWORD.toCharArray())
        }
        return ks
    }
}
