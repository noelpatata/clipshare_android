...
object ImageCompressor {
    ...
    fun compress(context: Context, uri: Uri, maxPayloadKb: Int): ByteArray? {
        val maxRawBytes = (maxPayloadKb * 1024 * 0.75).toInt()
        ...
        val isJpeg = mime.equals("image/jpeg", ignoreCase = true)
        ...
        bitmap = scaleDown(bitmap, maxDimension = 1280)
        ...
        while (attempts < 5) {
            ...
            val newWidth = (bitmap.width * 0.7).toInt().coerceAtLeast(320)
